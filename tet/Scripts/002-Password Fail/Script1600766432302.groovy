...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Password_password'), 'kaeWFNiBXgUGVNk1ODWsfg==')

WebUI.verifyElementPresent(findTestObject('Page_CURA Healthcare Service/input_Username_username'), 0)
